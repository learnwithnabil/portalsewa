            ...
            <form class="mt-16" action="{{ route('login') }}" method="post">
                ...
                <div class="mt-4 flex items-center justify-between space-x-2">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100" href="{{ route('password.request') }}">
