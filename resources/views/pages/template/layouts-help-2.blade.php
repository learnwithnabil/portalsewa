    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between space-x-6 py-5 lg:py-6">
            <div class="flex items-center space-x-4">
                ...
                <div class="my-1 hidden w-px self-stretch bg-slate-300 sm:flex"></div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-4 lg:gap-6">
            <a href="#" class="card items-center space-y-2 bg-primary py-10 px-4 text-center">
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                <div class="card">
                    ...
                    <div x-data="{ expandedItem: 'item-1' }"
                        class="flex flex-col divide-y divide-slate-150 px-4 sm:px-5">
                        <div x-data="accordionItem('item-1')">
                            <div @click="expanded = !expanded"
                                class="flex cursor-pointer items-center py-4 justify-between text-base font-medium text-slate-700">
                                <p>Question 1</p>
