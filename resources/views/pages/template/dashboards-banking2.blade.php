        ...
        <div class="mt-4 grid grid-cols-12 gap-4 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            ...
            <div class="card group col-span-12 pb-5 lg:col-span-8">
                ...
                <div class="grid grid-cols-12 gap-4 px-4 sm:gap-5 sm:px-5 lg:gap-6 lg:px-5">
                    ...
                    <div class="col-span-12 rounded-lg bg-slate-50 p-3 sm:col-span-6 xl:col-span-5">
                        <div class="space-y-4">
            ...
            <div class="card col-span-12 px-4 pb-5 sm:px-5 lg:col-span-4">
                <div class="flex items-center justify-between py-3">
                    ...
                    <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                        class="inline-flex">
                        <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                            class="btn -mr-1 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z" />
                ...
                <div class="mt-2 space-y-4">
                    ...
                    <div>
                        ...
                        <div class="mt-1.5 flex h-9 -space-x-px">
                            <select
                                class="form-select rounded-l-lg border border-slate-300 bg-white px-3 py-2 pr-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary">
                                <option>$</option>
                                <option>£</option>
                                <option>€</option>
                            </select>
                ...
                <div class="mt-5 flex justify-between text-slate-400">
                    <p class="text-xs+">Commission:</p>
                    <p>3$</p>
                </div>
                <div class="mt-2 flex justify-between">
                    <p>Total:</p>
                    <p class="font-medium text-slate-700">3$</p>
                </div>
                <button
                    class="btn mt-5 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                    Send Money
                </button>
            </div>
        </div>
