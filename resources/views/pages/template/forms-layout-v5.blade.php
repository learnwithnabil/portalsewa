    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="col-span-12 lg:col-span-4">
                <div class="card p-4 sm:p-5">
                    ...
                    <ul class="mt-6 space-y-1.5 font-inter font-medium">
                        <li>
                            <a class="flex items-center space-x-2 rounded-lg bg-primary px-4 py-2.5 tracking-wide text-white outline-none transition-all"
                                href="#">
                        ...
                        <li>
                            <a class="group flex space-x-2 rounded-lg px-4 py-2.5 tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800"
                                href="#">
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="card">
                    <div
                        class="flex flex-col items-center space-y-4 border-b border-slate-200 p-4 sm:flex-row sm:justify-between sm:space-y-0 sm:px-5">
                    ...
                    <div class="p-4 sm:p-5">
                        <div class="flex flex-col">
                            ...
                            <div class="avatar mt-1.5 h-20 w-20">
                                ...
                                <div
                                    class="absolute bottom-0 right-0 flex items-center justify-center rounded-full bg-white">
                                    <button
                                        class="btn h-6 w-6 rounded-full border border-slate-200 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <label class="block">
                                ...
                                <span class="relative mt-1.5 flex">
                                    <input
                                        class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary"
                        ...
                        <div class="my-7 h-px bg-slate-200"></div>
                        <div>
                            <h3 class="text-base font-medium text-slate-600">
                                Linked Accounts
                            </h3>
                            ...
                            <div class="flex items-center justify-between pt-4">
                                ...
                                <button
                                    class="btn h-8 rounded-full border border-slate-200 px-3 text-xs+ font-medium text-primary hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80">
                                    Connect
                                </button>
                            </div>
                        </div>
