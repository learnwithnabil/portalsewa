                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="is-scrollbar-hidden grow overflow-y-auto">
                            ...
                            <li>
                                <a class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-slate-800">Sent</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-slate-800">Draft</span>
                                    </div>
                                </a>
                            </li>
                            <li>
                                <a class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <span class="text-slate-800">Span</span>
                                    </div>
                        ...
                        <ul class="mt-1 space-y-1.5 px-2 font-inter text-xs+ font-medium">
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-4.5 w-4.5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500"
                            ...
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <span class="text-slate-800">Saved</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <span class="text-slate-800">Archive</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="h-4.5 w-4.5 text-secondary" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                    </svg>
                                    <span class="text-slate-800">Work</span>
                                </a>
                            </li>
                            <li>
                                <a class="group flex space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100"
                                    ...
                                    <span class="text-slate-800">Personal</span>
                                </a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="sidebar-panel-min">
            <div class="flex h-full flex-col items-center bg-white">
                <div class="flex h-18 shrink-0 items-center justify-center">
                    <div
                        class="avatar flex h-10 w-10 rounded-full bg-primary/10 text-primary">
                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    <div class="is-scrollbar-hidden flex grow flex-col overflow-y-auto">
                        <ul class="mt-4 space-y-1">
                            ...
                            <li>
                                <a href="#"
                                    class="btn h-10 w-10 bg-primary/10 p-0 font-medium text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5.5 w-5.5" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                                            d="M8 4H6a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-2m-4-1v8m0 0l3-3m-3 3L9 8m-5 5h2.586a1 1 0 01.707.293l2.414 2.414a1 1 0 00.707.293h3.172a1 1 0 00.707-.293l2.414-2.414a1 1 0 01.707-.293H20" />
    ...
    <main class="main-content mail-app w-full px-[var(--margin-x)] pb-6">
        <div class="flex flex-col-reverse py-5 sm:flex-row sm:justify-between">
            <div class="mt-2 flex items-center justify-between space-x-1">
                <div class="flex items-center px-2.5">
                    ...
                    <div x-data="usePopper({ placement: 'bottom-start', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                        class="inline-flex">
                        <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                            class="btn -ml-1 h-5 w-5 rounded p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                        ...
                        <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                            <div
                                ...
                                <ul>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">All</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">None</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">Read</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">Starred</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">Unread</a>
                                    </li>
                                    <li>
                                        <a href="#"
                                            class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800">Unstarred</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="flex justify-between">
                <div class="text-lg font-medium text-slate-700 sm:hidden">
                    Inbox
                </div>
        ...
        <div class="card">
            <div
                class="flex cursor-pointer flex-col rounded-t-lg border-b p-2.5 font-semibold text-slate-700 hover:bg-slate-100 sm:flex-row sm:items-center">
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2 sm:w-72">
                        <div class="flex">
                            <label class="flex h-8 w-8 items-center justify-center" x-tooltip="'Select'">
                                <input
                                    class="form-checkbox is-outline h-4.5 w-4.5 rounded border-slate-400/70 before:bg-primary checked:border-primary hover:border-primary focus:border-primary"
                                    type="checkbox" />
                            </label>
                            <button x-tooltip="'Starred'"
                                class="btn hidden h-8 w-8 rounded-full p-0 text-slate-400 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 sm:inline-flex">
                ...
                <div class="flex flex-1 items-center justify-between space-x-2">
                    <div class="flex items-center space-x-2 px-2">
                        ...
                        <div
                            class="badge hidden h-6 rounded-full border border-secondary text-secondary lg:inline-flex">
                            Work
                        </div>
                    </div>
                    <div class="flex sm:hidden">
                        <button x-tooltip="'Starred'"
                            class="btn h-8 w-8 rounded-full p-0 text-slate-400 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                            <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5" class="h-5 w-5"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
            ...
            <div
                class="flex cursor-pointer flex-col border-b p-2.5 font-semibold text-slate-700 hover:bg-slate-100 sm:flex-row sm:items-center">
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2 sm:w-72">
                        <div class="flex">
                            <label class="flex h-8 w-8 items-center justify-center" x-tooltip="'Select'">
            ...
            <div
                class="flex cursor-pointer flex-col border-b p-2.5 hover:bg-slate-100 sm:flex-row sm:items-center">
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2 sm:w-72">
                        <div class="flex">
                            <label class="flex h-8 w-8 items-center justify-center" x-tooltip="'Select'">
            ...
            <div
                class="flex cursor-pointer flex-col rounded-b-lg p-2.5 hover:bg-slate-100 sm:flex-row sm:items-center">
                <div class="flex items-center justify-between">
                    <div class="flex space-x-2 sm:w-72">
                        <div class="flex">
                            <label class="flex h-8 w-8 items-center justify-center" x-tooltip="'Select'">
        ...
        <div class="mt-4 flex flex-col space-y-1 px-5 text-xs sm:flex-row sm:justify-between sm:space-y-0">
            <a href="#" class="hover:text-slate-700 hover:underline">Term &amp;
                Privacy</a>
            <p>Last activity: 3 minute ago</p>
        </div>
    </main>

    <div class="fixed right-3 bottom-3 rounded-full bg-white">
        <button
