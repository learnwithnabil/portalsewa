                ...
                <div class="flex space-x-5 px-5">
                    ...
                    <div class="mt-2 w-full">
                        <div class="flex justify-between space-x-3">
                            <h4 class="text-base font-medium text-slate-700 line-clamp-1">
                                John Doe
                            </h4>
                            <div x-data="usePopper({ placement: 'bottom-end', offset: 4 })" @click.outside="if(isShowPopper) isShowPopper = false"
                                class="inline-flex">
                                <button x-ref="popperRef" @click="isShowPopper = !isShowPopper"
                                    class="btn -mr-1.5 h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                        ...
                        <a href="#"
                            class="cursor-pointer text-xs+ text-primary hover:text-primary-focus">@johndoe</a>
                    </div>
                </div>
                <div class="my-4 mx-5 h-px bg-slate-200"></div>
                <ul class="grow space-y-1.5 px-5 font-inter font-medium">
                    <li>
                        <a class="flex items-center space-x-2 rounded-full bg-primary px-5 py-2.5 tracking-wide text-white outline-none transition-all"
                            href="#">
                    ...
                    <li>
                        <a class="group flex space-x-2 rounded-full px-5 py-2.5 tracking-wide outline-none transition-all hover:bg-primary/10 hover:text-primary focus:bg-primary/10 focus:text-primary"
                            href="#">
