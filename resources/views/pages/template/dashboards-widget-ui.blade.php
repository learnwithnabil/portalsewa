        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <div class="inline-space flex flex-wrap">
                        ...
                        <a href="#"
                            class="tag bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                            Bootstrap
                        </a>
                        <a href="#"
                            class="tag bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                ...
                <div class="card p-4">
                    <div class="flex -space-x-px">
                        <input
                            class="form-input h-10 w-full rounded-l-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary"
                            placeholder="Search here..." type="text" />
                        <button
                            class="btn z-2 h-10 w-10 shrink-0 rounded-l-none bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card flex-row space-x-4 p-3">
                    ...
                    <div>
                        <p class="text-base font-medium tracking-wide text-slate-700">
                            Design Updated
                        </p>
                        <p class="mt-2 text-xs+">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                ...
                <div class="flex space-x-4 sm:space-x-5 lg:space-x-6">
                    <div class="card flex-1 p-4">
                        ...
                        <div class="mt-3 text-center">
                            <p class="text-3xl font-semibold text-slate-600">
                                234
                            </p>
                ...
                <div class="card px-4 pb-4 sm:px-5">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div
                            class="relative flex flex-col items-center justify-center rounded-lg border border-slate-200 p-4">
                            <div class="absolute top-0 right-0 mx-2 my-1">
                                <button
                                    class="text-slate-400 transition-colors hover:text-slate-800 focus:text-slate-800">
                            ...
                            <p class="mt-1.5 font-medium text-slate-700 line-clamp-1">
                                John D.
                            </p>
                            <button
                                class="btn mt-3 h-6 rounded-full bg-slate-150 px-3 text-xs font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                                Follow
                            </button>
                        </div>
                        <div
                ...
                <div class="card flex-row items-center space-x-4 p-4">
                    ...
                    <div>
                        ...
                        <div class="flex text-xs+">
                            <a href="#"
                                class="text-primary hover:text-primary-focus">Konnor</a>
                            <div class="mx-2 my-1 w-px bg-slate-200"></div>
                            <a href="#"
                                class="text-primary hover:text-primary-focus">John</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                <div class="card p-4 sm:p-5">
                    <div class="flex items-center justify-between">
                        <p class="text-sm+ font-medium tracking-wide text-slate-700">
                            Share
                        </p>
                        <button
                            class="btn h-7 w-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25">
                    ...
                    <div class="mt-4 grid grid-cols-4 gap-3">
                        <div class="text-center">
                            ...
                            <p class="mt-1.5 text-xs+ font-medium text-slate-700 line-clamp-1">
                                John
                            </p>
                        </div>
                        <div class="text-center">
                ...
                <div class="card space-y-4 p-4 sm:p-5">
                    <div class="flex items-center space-x-4">
                        <div class="h-5 w-5 rounded border-2 bg-transparent"></div>
                        <p>Not Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div class="h-5 w-5 rounded border-2 border-primary bg-transparent"></div>
                        <p>Primary Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                        <div
                            class="h-5 w-5 rounded border-2 border-secondary bg-transparent">
                        </div>
                        <p>Secondary Color</p>
                    </div>
                    <div class="flex items-center space-x-4">
                ...
                <div class="card px-4 pb-5 sm:px-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-3">
                            <div
                                class="mask is-squircle flex h-10 w-10 items-center justify-center bg-primary/10">
                                <i class="fa-solid fa-spinner text-xl text-primary"></i>
                            </div>
                            <div class="grow space-y-1">
                                <div class="flex justify-between">
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="inline-space mt-3 flex flex-wrap">
                        <div class="badge space-x-2.5 p-0 text-primary">
                            <div class="h-2 w-2 rounded-full bg-current"></div>
                            <span>HTML</span>
                        </div>
                        <div class="badge space-x-2.5 p-0 text-secondary">
                            <div class="h-2 w-2 rounded-full bg-current"></div>
                            <span>CSS</span>
                        </div>
            ...
            <div class="space-y-4 sm:space-y-5 lg:space-y-6">
                ...
                <div class="card p-4 sm:p-5">
                    ...
                    <div class="mt-2">
                        <div class="badge h-5 bg-success/10 px-2 text-success">
                            UI/UX Design
                        </div>
                        <div class="badge h-5 bg-warning/10 px-2 text-warning">
                            Mobile
                        </div>
                    </div>
                ...
                <div class="card">
                    <h3 class="p-4 text-sm+ font-medium tracking-wide text-slate-700 sm:p-5">
                        New Followers
                    </h3>
