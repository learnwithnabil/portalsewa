            ...
            <div class="card px-4 pb-4 sm:px-5">
                ...
                <div>
                    ...
                    <div class="inline-space mt-5">
                        <a
                            href="#"
                            class="tag rounded-full border border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25"
                        >
                            Primary
                        </a>
                ...
                <div>
                    ...
                    <div class="inline-space mt-5 flex flex-wrap">
                        <div class="flex -space-x-px">
                            <a
                                href="#"
                                class="tag rounded-r-none bg-slate-150 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80"
                            >
                                Primary
                            </a>
                            <a
                                href="#"
                                class="tag rounded-l-none bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90"
                            >
                                55
                            </a>
                        </div>
                        ...
                        <div class="flex -space-x-px">
                            <a
                                href="#"
                                class="tag rounded-r-none bg-slate-150 px-4 text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80"
                            >
                                Star
                            </a>
                            <a
                        ...
                        <div
                            class="badge space-x-2 rounded-full bg-slate-150 text-slate-800"
                        >
                            <i
                                class="fa-solid fa-person-biking text-sm text-slate-600"
                            ></i>
                            <span>Default</span>
                            <button
                                class="btn h-4.5 w-4.5 rounded-full bg-black/20 p-0 hover:bg-black/30 focus:bg-black/30"
                            >
