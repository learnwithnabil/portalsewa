                        ...
                        <div class="card flex-row overflow-hidden">
                            ...
                            <div class="flex flex-1 flex-col justify-between p-4 sm:px-5">
                                <div>
                                    ...
                                    <h3 class="mt-3 font-medium text-slate-700 line-clamp-2">
                                        Basic English
                                    </h3>
                                    <p class="text-xs+">Mon. 08:00 - 09:00</p>
                                    <div class="mt-2 flex space-x-1.5">
                                        <a href="#"
                                            class="tag bg-primary py-1 px-1.5 text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90">
                                            Language
                                        </a>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    <tr class="border-y border-transparent border-b-slate-200">
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                <div
                                                    class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary/10">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5.5 w-5.5 text-primary"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <span class="font-medium text-slate-700">Basic
                                                    English</span>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="badge space-x-2.5 text-slate-800">
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200">
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <span class="font-medium text-slate-700">Grammar and
                                                    Punctuation
                                                </span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="badge space-x-2.5 text-secondary">
                                                <div class="h-2 w-2 rounded-full bg-current"></div>
                                                <span>Can Edit</span>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200">
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                <div
                                                    class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-secondary/10">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5.5 w-5.5 text-secondary"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5"
                                                ...
                                                <span class="font-medium text-slate-700">Practice
                                                    speaking English
                                                </span>
                                            </div>
                                        </td>
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200">
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                <div
                                                    class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-info/10">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5.5 w-5.5 text-info" fill="none"
                                                        viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5"
                                    ...
                                    <tr class="border-y border-transparent border-b-slate-200">
                                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                <div
                                                    class="relative flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-warning/10">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-5.5 w-5.5 text-warning"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1.5"
                                    ...
                                    <tr class="border-y border-transparent">
                                        <td class="whitespace-nowrap rounded-bl-lg px-4 py-3 sm:px-5">
                                            <div class="flex items-center space-x-4">
                                                ...
                                                <span class="font-medium text-slate-700">Basic of
                                                    digital marketing
                                                </span>
                                            </div>
                                        </td>
                            ...
                            <div class="card p-3">
                                <div class="flex items-center justify-between space-x-2">
                                    ...
                                    <div class="relative cursor-pointer">
                                        <button
                                            class="btn h-8 w-8 rounded-full bg-slate-150 p-0 font-medium text-slate-700 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
