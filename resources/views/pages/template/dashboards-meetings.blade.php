    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="mt-4">
            ...
            <div class="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
                <div class="card justify-between bg-primary p-4 sm:p-5">
                        ...
                        <div class="mt-5 flex items-center justify-between space-x-2">
                            <div class="flex -space-x-3">
                                <div class="avatar h-8 w-8 hover:z-10">
                                    <img class="rounded-full ring-1 ring-primary"
                                        src="{{ asset('images/200x200.png') }}" alt="avatar" />
                                </div>
                                <div class="avatar h-8 w-8 hover:z-10">
                                    <div
                                        class="is-initial rounded-full bg-info text-xs+ uppercase text-white ring-1 ring-primary">
                                        qa
                                    </div>
                                </div>
                                <div class="avatar h-8 w-8 hover:z-10">
                ...
                <div class="card justify-between p-4 sm:p-5">
                    ...
                    <div class="mt-4">
                        ...
                        <div
                            class="badge mt-2 bg-primary/10 text-primary">
                            6 Members
                        </div>
                        <div class="mt-5 flex items-center justify-between space-x-2">
                            <div class="flex -space-x-3">
