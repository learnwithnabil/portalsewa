        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                            ...
                            <div>
                                ...
                                <p class="text-tiny+ text-slate-400 line-clamp-1">
                                    2 min read
                                </p>
                            </div>
                        </div>
            ...
            <div class="card flex-row justify-between space-x-2 p-2.5">
                <div class="flex flex-1 flex-col justify-between">
                    <div class="line-clamp-3">
                        <a href="#"
                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">NodeJS
                            Design Patterns</a>
                    </div>
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
            ...
            <div class="card flex-row justify-between space-x-2 p-2.5">
                <div class="flex flex-1 flex-col justify-between">
                    <div class="line-clamp-3">
                        <a href="#"
                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">313
            ...
            <div class="card flex-row justify-between space-x-2 p-2.5">
                <div class="flex flex-1 flex-col justify-between">
                    <div class="line-clamp-3">
                        <a href="#"
                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">Food:
            ...
            <div class="card flex-row justify-between space-x-2 p-2.5">
                <div class="flex flex-1 flex-col justify-between">
                    <div class="line-clamp-3">
                        <a href="#"
                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">The
            ...
            <div class="card flex-row justify-between space-x-2 p-2.5">
                <div class="flex flex-1 flex-col justify-between">
                    <div class="line-clamp-3">
                        <a href="#"
                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">How
