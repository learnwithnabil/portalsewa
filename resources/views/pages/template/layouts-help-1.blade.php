        ...
        <div class="mt-20 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
            <div class="col-span-12 lg:col-span-4 xl:col-span-3">
                <div class="card p-4 sm:px-5">
                    <ul class="space-y-3.5 font-inter font-medium">
                        <li>
                            <a class="inline-flex items-center space-x-2 tracking-wide text-primary outline-none"
                                href="#">
                        ...
                        <li>
                            <a class="group inline-flex items-center space-x-2 tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-slate-800"
                                href="#">
                                <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                <div class="flex items-center space-x-2 pb-4">
                    <div
                        class="flex h-7 w-7 items-center justify-center rounded-lg bg-primary/10 p-1 text-primary">
