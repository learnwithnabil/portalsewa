    ...
    <main class="main-content w-full px-[var(--margin-x)]">
        <div class="grid grid-cols-12 lg:gap-6">
            <div class="col-span-12 pt-6 lg:col-span-8 lg:pb-6">
                <div class="card p-4 lg:p-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                    ...
                                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                                        <div class="popper-box">
                                            <div
                                                ...
                                                <p
                                                    class="mt-2 font-medium tracking-wide text-slate-700">
                                                    Travis Fuller
                                                </p>
                                                <a href="#"
                                                    class="font-inter text-xs tracking-wide hover:text-primary focus:text-primary">@travisfuller
                                                </a>
                                                <button
                                ...
                                <div>
                                    <a href="#"
                                        class="font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary">
                                        Travis Fuller
                                    </a>
                        ...
                        <div class="mt-6 flex items-center space-x-3 sm:hidden">
                            <button
                                class="btn space-x-2 rounded-full border border-slate-300 px-4 text-xs+ font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80">
                    ...
                    <div class="mt-6 font-inter text-base text-slate-600">
                        ...
                        <br />
                        <ul class="list-inside list-disc font-medium text-slate-800">
                            <li>
                            ...
                            <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                                ...
                                <div class="grow">
                                    <div class="mt-2 flex items-center text-xs">
                                        <a href="#"
                                            class="flex items-center space-x-2 hover:text-slate-800">
                                        ...
                                        <div class="mx-3 my-1 w-px self-stretch bg-slate-200"></div>
                                        <span class="shrink-0 text-slate-400">June 23, 2021
                                        </span>
                                    </div>
                                </div>
                                <div class="mt-1 flex justify-end">
                                    <a href="#"
                                        class="btn px-2.5 py-1.5 font-medium text-primary hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25">
                                        READ ARTICLE
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                                ...
                                <div class="grow">
                                    <div class="mt-2 flex items-center text-xs">
                                        ...
                                        <div class="mx-3 my-1 w-px self-stretch bg-slate-200"></div>
                                        <span class="shrink-0 text-slate-400">May 25, 2021
                                        </span>
                                    </div>
                                </div>
                                <div class="mt-1 flex justify-end">
                            ...
                            <div class="flex w-full grow flex-col px-4 py-3 sm:px-5">
                                ...
                                <div class="grow">
                                    <div class="mt-2 flex items-center text-xs">
                                        ...
                                        <div class="mx-3 my-1 w-px self-stretch bg-slate-200"></div>
                                        <span class="shrink-0 text-slate-400">March 14, 2022
                                        </span>
                                    </div>
                                </div>
                                <div class="mt-1 flex justify-end">
            ...
            <div class="col-span-12 py-6 lg:sticky lg:bottom-0 lg:col-span-4 lg:self-end">
                <div class="card">
                    ...
                    <div class="px-4 pt-2 pb-5 sm:px-5">
                        ...
                        <div class="mt-5 flex space-x-1">
                            <button
                                class="btn h-7 rounded-full bg-slate-150 px-3 text-xs+ font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                                Follow
                            </button>
                            <button
                                class="btn h-7 w-7 rounded-full bg-slate-150 px-0 text-xs+ font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80">
                ...
                <div class="mt-5">
                    <p
                        class="border-b border-slate-200 pb-2 text-base text-slate-800">
                        ...
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 text-slate-800 line-clamp-3">
                                        <a href="#"
                        ...
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 text-slate-800 line-clamp-3">
                                        <a href="#"
                                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">Top
                                            Design Systems</a>
                                    </div>
                                </div>
                                <div class="flex items-center justify-between">
                        ...
                        <div class="flex justify-between space-x-2">
                            <div class="flex flex-1 flex-col justify-between">
                                <div>
                                    ...
                                    <div class="mt-1 text-slate-800 line-clamp-3">
                                        <a href="#"
                                            class="font-medium text-slate-700 hover:text-primary focus:text-primary">25
