<x-app-layout title="Project Board" is-header-blur="true">
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        ...
        <div class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6 xl:grid-cols-4">
            ...
            <div class="card shadow-none">
                <div
                    class="flex flex-1 flex-col justify-between rounded-lg bg-error/15 p-4 sm:p-5">
                    <div>
                        <div class="flex items-start justify-between">
                            <img class="h-12 w-12 rounded-lg object-cover object-center"
                    ...
                    <div>
                        <div class="mt-4">
                            ...
                            <div class="progress my-2 h-1.5 bg-error/15">
            ...
            <div class="card shadow-none">
                <div
                    class="flex flex-1 flex-col justify-between rounded-lg bg-primary/15 p-4 sm:p-5">
                    <div>
                        <div class="flex items-start justify-between">
                            <img class="h-12 w-12 rounded-lg object-cover object-center"
                                src="{{ asset('images/800x600.png') }}" alt="image" />
                    ...
                    <div>
                        <div class="mt-4">
                            ...
                            <div class="progress my-2 h-1.5 bg-primary/15">
                                <div class="w-6/12 rounded-full bg-primary"></div>
                            </div>
                            <p class="text-right text-xs+ font-medium text-primary">
                                52%
                            </p>
                        </div>
                        ...
                        <div class="mt-5 flex flex-wrap -space-x-3">
                            ...
                            <div class="avatar h-8 w-8 hover:z-10">
                                <div
                                    class="is-initial rounded-full border-2 border-white bg-info text-xs+ uppercase text-white">
                                    vf
                                </div>
                            </div>
                        ...
                        <div class="mt-4 flex items-center justify-between space-x-2">
                            <div class="badge h-5.5 rounded-full bg-primary px-2 text-xs+ text-white">
                                3 week left
                            </div>
                            <div>
                                <button
            ...
            <div class="card shadow-none">
                <div
                    class="flex flex-1 flex-col justify-between rounded-lg bg-warning/15 p-4 sm:p-5">
                    <div>
                        <div class="flex items-start justify-between">
                            <img class="h-12 w-12 rounded-lg object-cover object-center"
                    ...
                    <div>
                        <div class="mt-4">
                            ...
                            <div class="progress my-2 h-1.5 bg-warning/15">
